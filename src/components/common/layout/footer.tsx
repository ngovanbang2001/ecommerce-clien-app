    ...
    <div>
      ...
      <div className="flex justify-between items-center py-[30px] border-t-[1px] border-gray">
        ...
        <div className="flex gap-[20px]">
          <Link href="#">
            <TiSocialTwitter size="24px" className="text-gray" />
          </Link>
          <Link href="#">
            <TiSocialYoutube size="24px" className="text-gray"  />
          </Link>
          <Link href="#">
            <TiSocialFacebook size="24px" className="text-gray" />
          </Link>
          <Link href="#">
            <TiSocialInstagram size="24px" className="text-gray" />
          </Link>
        </div>
        <div>
          <ul className="flex gap-[40px]">
            <li>
              <Link href="#" className="text-gray font-thin">
                About us
              </Link>
            </li>
            <li>
