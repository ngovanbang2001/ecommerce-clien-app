  ...
  return (
    <div className="relative group cursor-pointer flex flex-col ease-in-out duration-300">
      <div className="relative">
        <Image className="!relative ease-in-out group-hover:hidden duration-300" src={images[0].url} alt="" layout='fill' objectFit='cover' />
        <Image className="!relative hidden group-hover:block  ease-in-out duration-300" src={images[1].url} alt="" layout='fill' objectFit='cover' />
